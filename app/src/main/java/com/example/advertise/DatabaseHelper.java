...
public class DatabaseHelper extends SQLiteOpenHelper {
    // table name:
    public static final String TABLE_NAME = "MOVIENOTES";
   ...
   // Database Information  database name
    static final String DB_NAME = "THE_MOVIE_APP.DB";

    // Database version (if we update app we need to change db version)
